...
function message_sender_mixin(entity_id, api_key) {
	request_mixin.call(this, entity_id, api_key);
...
message_sender_mixin.prototype.send = function(message_name, payload, callback) {
	var self = this;
...
message_sender_mixin.prototype.send_transaction = function(payload, callback) {
	var self = this;
